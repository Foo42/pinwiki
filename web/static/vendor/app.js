...
var _user$project$Models$initialModel = _user$project$Models$emptyModel;
...
var _user$project$Msg$BeginEdit = function (a) {
	return {ctor: 'BeginEdit', _0: a};
};
var _user$project$Msg$DefinitionAccepted = function (a) {
	return {ctor: 'DefinitionAccepted', _0: a};
};
var _user$project$Msg$ShowPlaceholder = function (a) {
...
var _user$project$Update$updatePlaceholderDefinition = F2(
	function (maybe, newDefinition) {
		var _p0 = maybe;
		if (_p0.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
...
var _user$project$Update$findById = F2(
	function (targetId, items) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (item) {
					return _elm_lang$core$Native_Utils.eq(item.uid, targetId);
				},
				items));
	});
var _user$project$Update$definitionChanged = F2(
	function (newDefinition, item) {
...
var _user$project$View$eventPos = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Models$Position,
...
var _user$project$View$itemBeingEdited = function (items) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filter,
			function (_) {
...
var _user$project$View$toPxString = function (pos) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(pos),
		'px');
};
var _user$project$View$itemClasses = function (item) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'placeholder',
						_1: _elm_lang$core$Native_Utils.eq(item.uid, 0)
					},
						{ctor: '_Tuple2', _0: 'item', _1: true},
						{ctor: '_Tuple2', _0: 'being-edited', _1: item.isEditing}
					]))));
};
var _user$project$View$itemView = function (item) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'top',
						_1: _user$project$View$toPxString(item.position.y)
					},
						{
						ctor: '_Tuple2',
						_0: 'left',
...
var _user$project$View$placeholderView = function (maybe) {
	var _p0 = maybe;
	if (_p0.ctor === 'Just') {
		return _user$project$View$itemView(_p0._0);
	} else {
		return _elm_lang$html$Html$text('click');
	}
};
var _user$project$View$boardView = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_1: A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(model.bottomRight.x),
							'px')
					},
						{
						ctor: '_Tuple2',
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$map, _user$project$View$itemView, model.items),
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$View$placeholderView(model.placeholder)
				])));
};
var _user$project$View$inputView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$placeholder('type...'),
						...
						A2(
							...
							A2(
								...
								_user$project$View$itemBeingEdited(model.items),
								function (_p1) {
									return _elm_lang$core$Maybe$Just(
										function (_) {
											return _.definition;
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$View$inputView(model)
			]));
};
